...
struct MCSchedModel {
  ...
  int computeInstrLatency(const MCSubtargetInfo &STI, unsigned SClass, unsigned Opcode) const;
  ...
  static double
  getReciprocalThroughput(const MCSubtargetInfo &STI, const MCSchedClassDesc &SCDesc, unsigned Opcode);

  static double
  getReciprocalThroughput(unsigned SchedClass, const InstrItineraryData &IID, unsigned Opcode);

  double
  getReciprocalThroughput(const MCSubtargetInfo &STI, const MCInstrInfo &MCII,
                          const MCInst &Inst, unsigned Opcode) const;
