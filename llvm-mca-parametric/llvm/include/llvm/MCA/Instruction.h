...
public:
  ReadState(const ReadDescriptor &Desc, unsigned RegID, unsigned OpCode)
      : RD(&Desc), RegisterID(RegID), PRFID(0), DependentWrites(0),
        CyclesLeft(UNKNOWN_CYCLES), OpCode(OpCode), TotalCycles(0), IsReady(true), 
