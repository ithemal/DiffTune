...
class InstrBuilder {
  ...
  void computeMaxLatency(InstrDesc &ID, const MCInstrDesc &MCDesc,
                         const MCSchedClassDesc &SCDesc,
                         const MCSubtargetInfo &STI);
  int getCycles(const MCInstrDesc &MCDesc, const MCSchedClassDesc &SCDesc, unsigned idx);
  int getResourceId(const MCInstrDesc &MCDesc, const MCSchedClassDesc &SCDesc, unsigned idx);
