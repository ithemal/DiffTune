...
RetireControlUnit::RetireControlUnit(const MCSchedModel &SM, const llvm::mca::Parameters &params)
  ...
  if (params.isPresent()) {
    assert(params.contains("microop-buffer-size"));
    AvailableSlots = params.readInt("microop-buffer-size");
  }
